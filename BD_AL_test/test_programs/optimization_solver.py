...
def optimization_solver_original(problem_definition: Dict[str, Any], solver_config: Dict[str, Any]) -> Dict[str, Any]:
    """
...
def target_function(a, b=None, c=None, d=None):
    ...
    Original function: target_function(problem_definition, solver_config)
